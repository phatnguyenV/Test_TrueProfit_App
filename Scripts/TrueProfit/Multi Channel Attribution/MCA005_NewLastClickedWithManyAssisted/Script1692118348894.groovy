...
WebUI.navigateToUrl((store_url + 'products/black-bean-bag') + AdGoogle.black_bean_2111)
...
WebUI.navigateToUrl((store_url + 'products/brown-throw-pillows') + AdTiktok.brown_throw_pillows_3111)
...
WebUI.navigateToUrl((store_url + 'products/copper-light') + AdSnapchat.copper_light_4111)
...
WebUI.navigateToUrl((store_url + 'products/cream-sofa') + AdPinterest.cream_sofa_5111)
...
WebUI.navigateToUrl((store_url + 'products/antique-drawers') + AdFacebook.antique_drawers_1112)
