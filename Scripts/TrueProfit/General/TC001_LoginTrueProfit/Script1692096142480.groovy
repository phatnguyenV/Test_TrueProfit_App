...
def full_url = GlobalVariable.protocal +  GlobalVariable.test_subdomain + GlobalVariable.store_domain_name

// Check if the browser is already open with the target URL
boolean isBrowserOpened = WebUI.verifyElementPresent(menubar, 2, FailureHandling.OPTIONAL)
